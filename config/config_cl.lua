...
Config['police'] = {
    ...
    scale   = 1.0, -- How big the blip is
    color   = 2, -- Color of the blip
    text    = 'Entorno' -- Message of the blip
}

Config['forzar'] = {
    sprite  = 520, -- Design of the blip
    scale   = 1.0, -- How big the blip is
    color   = 2, -- Color of the blip
    text    = 'Forzar' -- Message of the blip
}

Config.waitBeforeRemoval = 30000 -- Wait time before removing blip
